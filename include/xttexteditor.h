...
#ifndef _XTTEXTEDITOR_H
#define _XTTEXTEDITOR_H

#include <xtother.h>

/**
    @memo Simple text editor
*/
class XtTextEditor : public XtWindow {
public:
...
protected:
    ...
    XPoint Cursor, Position, Top;
    char *FileName;
    unsigned long LinesNo, ColsNo;
    TItem *Items, *CurrIndex;
    bool TextChanged;
    int ReadFile();
    bool SaveDialog();
